...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetData() async {
    const url = 'https://shop-flutter-571ff.firebaseio.com/products.json';
    try {
  ...
  Future<void> updateItem(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = 'https://shop-flutter-571ff.firebaseio.com/products/$id.json';
  ...
  Future<void> deleteProduct(String id) async {
    final url = 'https://shop-flutter-571ff.firebaseio.com/products/$id';
